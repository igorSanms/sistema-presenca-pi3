  ...
  return (
    <div className="max-w-[1310px] mx-auto w-full pb-10">
      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm">
        ...
        <p className="text-sm text-gray-500 mb-8 mt-1">Atualize as informações cadastrais do estudante</p>
        ...
        <form onSubmit={handleSave} className="flex flex-col gap-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input name="telefone" value={formData.telefone} onChange={handleChange} placeholder="(00) 00000-0000" className="w-full bg-gray-50 border border-gray-200 focus:bg-white focus:outline-none focus:ring-1 focus:ring-blue-500 rounded-md px-4 py-2.5 text-sm text-gray-900" />
            </div>
          </div>

          <div>
            <label className="block text-sm font-bold text-gray-400 mb-2">Número de Matrícula</label>
            <input value={matriculaSimulada} disabled className="w-full bg-gray-100 border border-transparent rounded-md px-4 py-2.5 text-sm text-gray-400 cursor-not-allowed" />
          </div>
